...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('2. Random Forest ROC: AUC = {0:0.2f}'.format(
          areaUnderROC))
plt.legend(loc="lower right")
plt.show()
...
plt.title('3. XG Boost PRC: Average Precision = {0:0.2f}'.format(
          average_precision))
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('3. XG Boost ROC:  AUC = {0:0.2f}'.format(areaUnderROC))
plt.legend(loc="lower right")
plt.show()
...
plt.title('4. Light GB PRC: Average Precision = {0:0.2f}'.format(
          average_precision))
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('4. Light GB ROC: AUC = {0:0.2f}'.format(areaUnderROC))
plt.legend(loc="lower right")
plt.show()
...
plt.title('5. TEST SET 1 LR PRC: Average Precision = {0:0.2f}'.format(
          average_precision))
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('5 TEST SET 1 LR ROC: AUC = {0:0.2f}'.format(areaUnderROC))
plt.legend(loc="lower right")
plt.show()
...
plt.title('5. TEST SET 2 RF PRC: Average Precision = {0:0.2f}'.format(
          average_precision))
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('5. TEST SET 2 RF ROC: AUC = {0:0.2f}'.format(areaUnderROC))
plt.legend(loc="lower right")
plt.show()
...
plt.title('5. TEST SET 3 XGB PRC: Average Precision = {0:0.2f}'.format(
          average_precision))
...
plt.title('5. TEST SET 3 XGB ROC: AUC = {0:0.2f}'.format(areaUnderROC))
plt.legend(loc="lower right")
plt.show()
...
plt.title('5. TEST SET 4 LGBM PRC: Average Precision = {0:0.2f}'.format(
          average_precision))
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('5. TEST SET 4 LGBM ROC: AUC = {0:0.2f}'.format(areaUnderROC))
plt.legend(loc="lower right")
plt.show()
...
plt.title('Ensemble PRC: Average Precision = {0:0.2f}'.format(
          average_precision))
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('Ensemble ROC: AUC = {0:0.2f}'.format(areaUnderROC))
plt.legend(loc="lower right")
plt.show()
